...
%---------------------------------------------------------
\cventry
  {Controlling Automation Lead} % Job title
  {HelloFresh} % Organization
  {Irving, TX} % Location
  {January 2026 - Present} % Date(s)
  {
    \begin{cvitems} % Description(s) of tasks/responsibilities
      \item {Architected and deployed enterprise-wide automation solutions for critical accounting workflows across global markets, eliminating manual processes in weekly close cycles and monthly financial reporting, reducing cycle time through automated reconciliation and variance analysis frameworks standardized across multiple countries and business units.}
      \item {Engineered sophisticated inventory valuation automation systems using Python and SQL for international operations, integrating real-time cost accounting logic, FIFO/weighted average calculations, multi-currency pricing algorithms, and regional compliance requirements to ensure accurate global financial reporting and eliminate manual spreadsheet dependencies.}
      \item {Led global cross-functional automation initiatives, partnering with Accounting, FP\&A, Operations, Procurement, and Supply Chain teams across US, European, and international markets to identify process bottlenecks, design scalable solutions, and implement standardized controlling processes that drive consistency and efficiency worldwide.}
      \item {Developed automated inventory-to-GL reconciliation tools and pricing variance monitoring systems deployed across global entities, implementing exception-based alerting, automated journal entry generation, and multi-entity consolidation workflows that improved data accuracy and reduced month-end close timelines for worldwide operations.}
      \item {Spearheaded the transformation of global controlling processes through intelligent automation, building scalable ETL pipelines that orchestrate data flows across regional ERP systems, international cost centers, and profit center reporting structures while maintaining SOX compliance, IFRS/GAAP standards, and audit trail integrity across jurisdictions.}
      \item {Built automated management reporting suites and interactive dashboards (Tableau, Streamlit) for global cost center performance, international inventory aging analysis, cross-market margin analytics, and regional pricing effectiveness, enabling real-time financial visibility across time zones and data-driven decision-making for global senior leadership.}
    \end{cvitems}
  }
...
\cventry
    ...
    {} % No organization (already mentioned above)
    {} % No location
